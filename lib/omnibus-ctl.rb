...
EOM
    ...
    def run_chef(attr_location, args='')
      ...
      cmd = "#{base_path}/embedded/bin/chef-client #{log_level} -z -c #{base_path}/embedded/cookbooks/solo.rb -j #{attr_location} --chef-license accept-silent"
